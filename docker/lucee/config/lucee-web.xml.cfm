<?xml version="1.0" encoding="UTF-8"?>
	<cfLuceeConfiguration hspw="${WEB-HSPW}" salt="${WEB-HSPW-SALT}" version="5"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	-->
	<regional locale="en_AU" timeserver="pool.ntp.org" timezone="PST8PDT" use-timeserver="true"/>
